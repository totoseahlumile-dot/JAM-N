  ...
  <div class="landing-page">
    <main class="landing-main">
      ...
      <div class="hero-actions">
        ...
        <RouterLink to="/login" class="sign-in-link">Already a member? Sign in</RouterLink>
      </div>
...
.sign-in-link { color: #65457e; font-weight: 700; text-decoration: none; }
